...
`,"getStyles"),ts=Ze,Ts={parser:ve,get db(){return new qe(2)},renderer:Je,styles:ts,init:p(t=>{t.state||(t.state={}),t.state.arrowMarkerAbsolute=t.arrowMarkerAbsolute},"init")};export{Ts as diagram};
